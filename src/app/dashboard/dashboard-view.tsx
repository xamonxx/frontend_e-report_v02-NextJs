  ...
  return (
    <TooltipProvider delay={400}>
      <div className="space-y-6">
        ...
        {/* Filter Panel for Trend Chart */}
        <div className="glass-panel p-4 border border-border/60 shadow-sm rounded-2xl dark:border-zinc-800/60 dark:bg-zinc-900/40">
          <div className="flex flex-col gap-1 mb-3">
            ...
            <p className="text-[10px] text-muted-foreground">Sesuaikan rentang periode untuk grafik tren di bawah.</p>
          </div>
          <div className={cn(
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <Card ref={trendCardRef} className="border-border/60 bg-card shadow-sm rounded-2xl overflow-hidden dark:border-zinc-800/60 dark:bg-zinc-900/40 dark:shadow-none">
